...
import setTokensREducer from './ducks/set-tokens.duck';
...
import fetchPatientBannerReducer from "./ducks/fetch-patient-banner.duck";
...
let reducers = {
  ...
  patientBanner: fetchPatientBannerReducer,
